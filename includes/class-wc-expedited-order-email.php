...
if ( ! class_exists( 'WC_Email_Custom_Customer_Processing_Order' ) ) :
 ...
 * @extends 	WC_Email
 */
class WC_Email_Custom_Customer_Processing_Order extends WC_Email {
	...
	function __construct() {
		...
		$this->id 				= 'custom_customer_processing_order';
		$this->title 			= __( 'Bestellbestätigung (Status Warteschleife bei: Vorkasse, Kauf auf Rechnung)', 'woocommerce' );
